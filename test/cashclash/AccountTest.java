...
public class AccountTest
{
    ...
    public void depositToSavingsGoesToSavings()
    {
        ...
        assertEquals(
            Account.SAVINGS,
            account.getTransactionHistory().get(0).getAccountType());
    }
    ...
    @Test
    public void withdrawReducesBalanceAndLogsOneTransaction()
        throws Exception
    {
        Account small = new Account("00002", 1_000);
        small.withdraw(200);
        ...
        assertEquals(
            "Withdrawal",
            small.getTransactionHistory().get(0).getType());
    }
    ...
    @Test
    public void withdrawUnderDailyLimitIncreasesDailyTotal()
        throws Exception
    {
        account.withdraw(100);
        assertEquals(
            Account.DAILY_WITHDRAWAL_LIMIT_CENTS - 100,
            account.getRemainingDailyLimit());
    }


    @Test
    public void withdrawOverDailyLimitThrowsEvenWithEnoughBalance()
        throws Exception
    {
        account.withdraw(Account.DAILY_WITHDRAWAL_LIMIT_CENTS); // exactly the
                                                                // limit is
                                                                // allowed
        assertThrows(
            ...
            () -> account.withdraw(1));
        assertEquals(
            100_000 - Account.DAILY_WITHDRAWAL_LIMIT_CENTS,
            account.getBalance());
    }


    @Test
    public void dailyLimitCountsCheckingAndSavingsTogether()
        throws Exception
    {
    ...
    @Test
    public void historyIsInChronologicalOrder()
        throws Exception
    {
        account.deposit(100);
    ...
    @Test
    public void newDayResetsDailyTotal()
        throws Exception
    {
    ...
    @Test
    public void resetTwiceOnSameDayIsANoOp()
        throws Exception
    {
        account.withdraw(20_000);
        account.resetDailyWithdrawalIfNewDay();
        account.resetDailyWithdrawalIfNewDay();
        assertEquals(
            Account.DAILY_WITHDRAWAL_LIMIT_CENTS - 20_000,
            account.getRemainingDailyLimit());
    }
    ...
    @Test
    public void remainingLimitIsLimitMinusWithdrawn()
        throws Exception
    {
        account.withdraw(20_000);
    ...
    @Test
    public void remainingLimitIsZeroNotNegativeAtTheLimit()
        throws Exception
    {
